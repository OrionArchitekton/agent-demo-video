...
function sampleInputs(): RenderInputs {
  return {
    ...
    config: {
      ...
      fps: 30,
      theme: { captionFont: "Liberation Sans", captionSize: 24, cursor: true, captionBox: true, captionMarginV: 20, annotations: { enabled: true, durationMs: 500, fontSize: 24, position: "top-right" as const } },
      out: "/local/work/out",
    },
  };
}
